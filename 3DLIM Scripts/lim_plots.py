...
class LimPlots:
    ...
    def centerline(self, log=False, fit_exp=False, grid=None):
        """
    ...
    def deposition_contour(self, side, probe_width=0.015, rad_cutoff=0.1, grid=None):
        """
    ...
    def avg_pol_profiles(self, probe_width=0.015, rad_cutoff=0.5, grid=None):
        """
